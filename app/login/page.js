        ...
        <div className="w-full flex mt-[-7rem]">
            ...
            <div className='contentWrapper flex flex-col justify-center pl-10 w-1/2'>
                ...
                <div className='formWrapper'>
                    <form className='form w-2/3 flex flex-col gap-5 mt-5' onSubmit={handleLogin}>
                        ...
                        <div className='fieldGroup flex flex-col'>
                            ...
                            <div className='passwordField relative flex flex-col items-end justify-center'>
                                <input type={show ? 'text' : 'password'} id='password' required value={password} onChange={(e) => setPassword(e.target.value)} placeholder='Please Enter Your Password' className='w-full border rounded-md outline-0 p-2' />
                                <button
                                    type="button"
